...
<asp:Content ID="signupcont" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    Enter name: <br />
    ...
    <br /><br /><br />
    Select authority: <br />
    <asp:DropDownList ID="auth" runat="server"></asp:DropDownList>
    <asp:RequiredFieldValidator ID="reqauth" runat="server" ErrorMessage="Kindly choose authority!!!"></asp:RequiredFieldValidator>
    <br /><br /><br />
    Enter password: <br />
